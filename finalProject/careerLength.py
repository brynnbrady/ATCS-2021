"""
A Linear Regression Model for predicting the length of a
tennis player's career given personal features about them
"""
...
''' 
Name: Career length linear regression class
Description: machine learning, linear regression model that makes predictions about how many years a tennis player
             will play professionally considering their personal statistics
'''
class CareerLengthLinRes:
    """ Constructor """
    def __init__(self):
        self.data = None
    ...
    def get_x_and_y(self):
        ...
        y = self.data["career_length"].values
        return x, y

    def create_model(self, x, y):
        """
        Create a linear regression model that predicts the length in years of a players' career based on their
        personal statistics
        Prints out weights (coefficients) for each personal stat and the model's intercept
        :param x: personal features about a player
        :param y: number of years that player played professional tennis
    ...
    def test_model(self, x_test, y_test):
        ...
        for index in range(len(x_test)):
            ...
            print("Height: ", x_height, " Starting Age: ", x_start_age, " Age Turned Pro: ", x_pro_age,
                  ...
                  " Predicted career length (years): ", y_pred, " Actual career length (years): ", actual)

''' Main - create a linear regression model that predicts the length of a players' career based on personal statistics '''
if __name__ == '__main__':
    # Create model variable and get data
    lin_res_model = CareerLengthLinRes()

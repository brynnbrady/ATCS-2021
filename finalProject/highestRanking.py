"""
A Linear Regression Model for predicting the highest career ranking a
tennis player will achieve given their personal features
"""
...
''' 
Name: Highest career ranking linear regression class
Description: machine learning, linear regression model that makes predictions about the highest career ranking a
             tennis player will achieve considering their personal statistics
'''
class HighestRankingLinRes:
    """ Constructor """
    def __init__(self):
        self.data = None
    ...
    def get_x_and_y(self):
        ...
        y = self.data["highest_pro_ranking"].values
        return x, y

    def create_model(self, x, y):
        """
        Create a linear regression model that predicts the highest career ranking a player will achieve based on their
        personal statistics
        Prints out weights (coefficients) for each personal stat and the model's intercept
        :param x: personal features about a player
        :param y: highest career ranking of a player
    ...
    def test_model(self, x_test, y_test):
        ...
        :param y_test: corresponding highest career ranking data
        :return: nothing
        """

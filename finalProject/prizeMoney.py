"""
A Linear Regression Model for predicting a player's career
prize money given personal features about them
"""
...
class PrizeMoneyLinRes:
    ...
    def create_model(self, x, y):
        """
        Create a linear regression model that predicts the career prize money a player earns based on their
        personal statistics
        Prints out weights (coefficients) for each personal stat and the model's intercept
        :param x: personal features about a player
        :param y: players' career prize money
    ...
    def test_model(self, x_test, y_test):
        ...
        :param y_test: corresponding career prize money testing data
        :return: nothing
        """
        ...
        for index in range(len(x_test)):
            ...
            print("Height: ", x_height, " Starting Age: ", x_start_age, " Age Turned Pro: ", x_pro_age,
                  ...
                  " Predicted career prize money: ", y_pred, " Actual career prize money: ", actual)

''' Main - create a linear regression model that predicts a player's career prize money based on personal statistics '''
